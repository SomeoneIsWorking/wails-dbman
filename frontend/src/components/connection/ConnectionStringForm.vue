<template>
  <div class="grid grid-cols-[120px_1fr] gap-3">
    <label class="text-right py-1">Connection String</label>
    <div class="space-y-4">
      ...
      <div
        ...
        class="p-3 bg-surface-hover/30 rounded border border-border/50 animate-in fade-in duration-200"
      >
        <div class="grid grid-cols-[80px_1fr] gap-x-2 gap-y-1 text-sm">
          <span
            class="text-foreground-secondary uppercase font-bold text-sm tracking-tight"
            >Host</span
          >
          ...
          >
          <div
            class="col-span-2 pt-2 border-t border-border/30 mt-1 flex items-center gap-1.5"
          >
            <div
